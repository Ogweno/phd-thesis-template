...
% package in the preamble.tex. You can use Greek Fonts (GFS)
%
...
% Print only extended summary in English as a seperated article. Use Abstract/Extsumfull Template. 
